...
class FirstViewController: UIViewController, UITableViewDataSource, UITableViewDelegate,  XMLParserManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //Set Title
        self.tabBarController?.navigationItem.title = "RSS Load From Server"
